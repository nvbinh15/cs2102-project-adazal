...
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (12, 15, 8, 11, '2021-10-07 20:37:57');
COMMIT;
...
insert into comment (id, user_id) values (12, 8);
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (12, 15, 8, 11, '2021-10-07 20:37:57');
INSERT INTO review_version (review_id, review_timestamp, content, rating) values (12, '2021-10-07 20:37:57', 'Biliary acute pancreatitis with uninfected necrosis', 1);
COMMIT;

-- Test trigger 8, comment is both a reply and review (transaction)
BEGIN;
INSERT INTO comment (id, user_id) VALUES (13, 4);
...
-- Test trigger 8, comment is both a reply and review, insert to review without transaction
BEGIN;
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (13, 9, 10, 14, '2021-04-12 13:40:58');
INSERT INTO review_version (review_id, review_timestamp, content, rating) values (13, '2021-04-12 13:40:58', 'Biliary acute pancreatitis with uninfected necrosis', 1);
COMMIT;
...
-- Test trigger 8, comment is both a reply and review, insert to reply without transaction
BEGIN;
INSERT INTO reply (id, other_comment_id) values (14, 4);
INSERT INTO reply_version (reply_id, reply_timestamp, content) values (14, '2021-01-02 20:43:27', 'Loose body in knee, left knee');
COMMIT;

-- Test trigger 7, make review and not purchase
BEGIN;
INSERT INTO comment (id, user_id) VALUES (15, 8);
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (15, 18, 7, 11, '2021-04-13 13:40:58');
INSERT INTO review_version (review_id, review_timestamp, content, rating) values (15, '2021-04-13 13:40:58', 'Biliary acute pancreatitis with uninfected necrosis', 1);
COMMIT;

-- Test trigger 7, make review with purchase
BEGIN;
INSERT INTO comment (id, user_id) VALUES (15, 8);
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (15, 19, 7, 11, '2021-04-13 13:40:58');
INSERT INTO review_version (review_id, review_timestamp, content, rating) values (15, '2021-04-13 13:40:58', 'Biliary acute pancreatitis with uninfected necrosis', 1);
COMMIT;

-- Test trigger 7, make review without purchase (user id not equal)
BEGIN;
INSERT INTO comment (id, user_id) VALUES (16, 9);
INSERT INTO review (id, order_id, shop_id , product_id, sell_timestamp) values (16, 19, 7, 11, '2021-04-13 13:40:58');
INSERT INTO review_version (review_id, review_timestamp, content, rating) values (16, '2021-04-13 13:40:58', 'Biliary acute pancreatitis with uninfected necrosis', 1);
COMMIT;
